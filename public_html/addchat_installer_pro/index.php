...
if($_POST && INSTALL_MODE === 1) {
	...
	if($core->validate_post($_POST) == true)
	{
        ...
        /**
         * 1. Verify license
         * 2. Verify connection to DB
         * 3. Write config and transfer to application
         * 4. Transfer controller, libraries & assets data
         * 5. Create AddChat db tables
          */
        if($core->verify($_POST['cb_res']) === false)
        {
            $message = $core->show_message('error', "Invalid License or Domain.");
        }
        else if($database->connect_database($_POST) == false) 
        {
...
<html lang="en">
<head>
    <title>AddChat Codeigniter Pro | Installer</title>
    <!-- &nbsp;&nbsp;(required) meta tags -->
    <meta charset="utf-8">
    ...
    &lt;/body&gt;
                ...
                <div class="card-heading">
                    <div class="instructions">
                        <h2 class="text-center"><small style="font-size: 12px !important;font-weight: 600 !important;">V1.0</small> AddChat Codeigniter Pro | Installer</h2>
                        <p style="text-align: center;font-size: 14px;"><strong><em>IMPORTANT! </em> Please read the installation guide in <a href="http://addchat-pro-docs.classiebit.com" style="color: #00BCD4 !important;" target="_blank">AddChat Pro docs</a></strong></p>
                    ...
                    <div class="row">
                        <div class="offset-md-2 col-md-8">
                            ...
                            <form class="form-signin" id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                <input type="hidden" name="cb_res" value="0" id="cb_res">
                                ...
                                <div class="form-group">
                                    <label for="license">License Code<small >&nbsp;&nbsp;(required)</small></label>
                                    <input type="text" id="license" placeholder="XXXXX-XXXXX-XXXXX-XXXXX" class="form-control form-control-lg text-uppercase" name="license" aria-describedby="licenseHelp" autocomplete="false"/>
                                    <small id="licenseHelp" class="form-text text-muted">Enter license code.</small>
                                </div>
                                
                                <br>
                                <button type="button" id="verify" class="btn btn-primary btn-lg btn-block">Install</button>
...
<script>
    ...
    $(function() {
        $('#verify').click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: 'https://cblicense.classiebit.com/verifyl',
                data: {
                    license_key: $('#license').val(), 
                    domain: window.location.hostname,
                    s_host: '<?php echo $_SERVER['REMOTE_ADDR']; ?>',
                    code: 'CBADCPRO01',
                },
                success: function(data){
                    if (typeof data.status !== 'undefined' && data.status != 0)
                        document.getElementById("cb_res").value = data.status;
                    
                    $("form#install_form" ).submit();
                }
            });
        });    
    })
