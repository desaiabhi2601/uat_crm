<?php  
	$last_ip = $this->session->userdata(last_ip);
	$last_login_date= $this->session->userdata(last_login);
	$current_ip = $this->session->userdata(current_ip);
	$current_date = $this->session->userdata(current_login);
?>
		...
		<div class="row d-flex justify-content-center">
			<div class="col-6">
				...
				<table class="table table-bordered">
					<tr>
						<td>Current Login Time: <?php echo date('d M Y H:i', strtotime($current_date));?></td>
						<td>Current IP Address: <?php echo $current_ip;?></td>
					</tr>
					<tr>
						<td>Last Login Time: <?php echo date('d M Y H:i', strtotime($last_login_date));?></td>
						<td>Last IP Address: <?php echo $last_ip;?></td>
					</tr>
				</table>
			</div>
		</div>
