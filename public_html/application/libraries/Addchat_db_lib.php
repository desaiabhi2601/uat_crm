...
class Addchat_db_lib 
{
    ...
    public function get_user($user_id = 0,  $logged_in_user  = 0, $guest_group_id = 0)
    {
        ...
        $select = array(
            "$this->users_tb.$this->users_tb_id id",
            "$this->users_tb.$this->users_tb_email email",
        ...
        if($guest_group_id > 0)
        {
            $is_guest_group =  "(SELECT UG.$this->ug_tb_user_id user_id  FROM $this->ug_tb  UG WHERE  UG.$this->ug_tb_user_id = $user_id AND                                            UG.$this->ug_tb_group_id = $guest_group_id) is_guest_group";
        ...
        return  $this->AC_LIB->db
                ->select($select)
                ->join($this->profiles_tb, "$this->profiles_tb.user_id = $this->users_tb.$this->users_tb_id", "inner")
    ...
    */
    ...
    public function get_chatgroups($group_ids = [], $is_admin = null)
    {
        ...
        $this->AC_LIB->db
            ->select(array(
                "$this->groups_tb_id id",
                "$this->groups_tb_name name",
    ...
    */
    public function a_get_groups()
    {
        return  $this->AC_LIB->db
                    ->select(array(
                        "$this->groups_tb.$this->groups_tb_id id",
                        "$this->groups_tb.$this->groups_tb_name name",
                    ))
                    ->get($this->groups_tb)
                    ->result();
    }
